...
const (
	...
	// TODO: Для production-окружения секрет должен передаваться через конфигурацию
	// (например переменную окружения JWT_SECRET), а не хардкодиться в коде.
	// Это сделано для упрощения учебного проекта.
	secret = "secret"
)
